...
archive of $79 \pm 1\,\mathrm{MB}$ ($\approx 12.0\times$
\emph{bitstream-rate} compression, exclusive of the predictor itself),
with byte-granular random-access query cost $\leq 50\,\mathrm{ms}$
per query on a single B100-class GPU. This matches the published
measurement of Delétang et al.\ (2024) Table 1.

\emph{Falsification:} (a) bitstream exceeds 90 MB at $\delta = 10^{-6}$
confidence band falsifies the end-to-end synthesis composition of
Theorems 7.2--7.5--7.14. (b) Self-contained (model + bitstream)
