...
archive outputs across (a) x86-64 Linux with stock libc, (b) ARM64
Linux on Apple Silicon, (c) RISC-V QEMU emulation, (d) Windows x86-64
with MSVC runtime, on a 100-block test corpus.
...
plus 3 definitions and 1 remark) is unchanged by experimental
