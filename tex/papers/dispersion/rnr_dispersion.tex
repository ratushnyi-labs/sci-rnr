...
geometrically ergodic under filter stability (the §7.15c/7.30a tool). Steps (i)--(iii), (iv-a), and (iv-c) are
...
\begin{itemize}
\item \emph{Functional CLT / streaming buffer (Theorem 7.36).} The centred
...
\item \emph{Large-deviation overflow exponent (Theorem 7.31).}
...
\item \emph{Moderate deviations / RA fade (Theorem 7.33).} The standardized
moderate-deviation law transfers (same $V$, mean shifted by $c$ per symbol).
\item \emph{Extreme-value worst-case query (Theorem 7.35).} The maximal block
