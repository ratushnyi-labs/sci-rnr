...
we treat the sharp replica spectral floor $R_A(s;D)\ge\tfrac32$ underlying
the convexity wall: proven in closed form at $A=2$ (all $s$, all
$D\le D_c$), and for $A\ge3$ established regionally --- an effective
tight-corner theorem at $A=3,\dots,6$, Schur certificates at small and
moderate $p$, a direct margin in the near-uniform pocket --- with the
mid-band certification program stated as the named residual.
...
prerequisites restated in Section~P below. Section, theorem, lemma, and
...
\textbf{P. Prerequisites (restated from the companion Parts)}
...
\emph{The lossy operational model (Theorem 7.7 of [RNR-II]).} Let
...
(second-order / dispersion characterisation). Preprint.
...
Part I: Framework, Constructions, and Complexity. Companion paper (RNR
series, Part I).

\textbf{{[}RNR-II{]}} Ratushnyi, P. (2026). Ratushnyi Neural Repair Coding,
Part II: Random Access, Finite-Block Surprisal, and the Deviation
Hierarchy. Companion paper (RNR series, Part II).
