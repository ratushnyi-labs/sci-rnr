...
\textbf{{[}141{]}} Zhu, J., and Alajaji, F. Rate-distortion analysis of
the binary memoryless source under the Hamming distortion measure
(second-order / dispersion characterisation).

\textbf{{[}142{]}} Hafouta, Y. (2020). Explicit Berry--Esseen and
...
\textbf{{[}146{]}} Krishnamachari, R. T. (2026). Second-order and
...
\textbf{{[}147{]}} Tasci, M. C., and Kostina, V. (2026). On the lossy
dispersion of sources with memory. Preprint.

\textbf{{[}148{]}} Eswaran, K., and Gastpar, M. (2022). Remote Source
...
\textbf{{[}155{]}} G\"otze, F., and Hipp, C. (1983). Asymptotic
