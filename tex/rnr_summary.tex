...
\textbf{A:} Theorem 5.6 ($\mathrm{TC}$ is the exact quantity);
Remark 5.7 (manifold hypothesis predicts
$\mathrm{TC} = \Theta(N)$ for natural data).

\textbf{Q:} \emph{``Doesn't arithmetic coding under $Q$ dominate
your support-set scheme?''}

\textbf{A:} Proposition 5.5: yes, and we say so explicitly.
...
\item Theorem 5.6 is unconditional; Remark 5.7's quantification
