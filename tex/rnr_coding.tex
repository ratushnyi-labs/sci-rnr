...
rather than of the partition representation. Type-III-A has a matching
\emph{relative} converse --- the $2\varepsilon$ approximate-oracle gap
is tight (Theorem 6.2) --- but a standalone \emph{absolute-rate}
converse for Type-III-A, and a converse for Type-III-C, remain open.
