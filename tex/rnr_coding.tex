...
(Azuma worst-case, T7.14) or $\pm 1.3$--$2.6\,\mathrm{MB}$
(variance-aware Bernstein, T7.25, replacing $B$ by $\sigma_\ell$
$\approx 2$ bits for English text) and practical concentration band
...
Azuma's $B(W_N+1)\sqrt{N}$ --- an improvement by factor $B /
\sigma_\ell \approx 16$ for English text. The end-to-end Chinchilla-class
prediction of Theorem 7.15 thus admits a tighter rigorous concentration
band: the $\approx 1.3\,\mathrm{GB}$ Azuma worst-case quoted in §11.7
becomes approximately $1.3$--$2.6\,\mathrm{MB}$ under Theorem 7.25's
hypotheses (with the precise constant depending on the specific
Merlev\`ede-Peligrad-Rio formulation), within $\sim 60\times$ of the
$\approx 42\,\mathrm{kB}$ practical CLT estimate. Theorem 7.14
...
$\sigma_\ell$ can be measured or upper-bounded.
