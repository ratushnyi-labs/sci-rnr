...
a fixed 140\,GB-class shared predictor is reached at total source
volume $V^* \approx 140\,\mathrm{GB} / (1 - H_{M'} \cdot 8^{-1}) \cdot
8 \approx 1.5\,\mathrm{TB}$ of compressible text --- a deployment scale
fully consistent with cloud-backup, archival-storage, and content-delivery
applications, but \emph{not} with single-document compression. Theorem
...
(C/m)^{1 - 1/\alpha}$ (Breslau et al.\ 1999 \emph{Proc.\ IEEE INFOCOM},
``Web caching and Zipf-like distributions: evidence and implications'').
For $\alpha > 1$ (heavy-tailed): $(C/m)^{1-1/\alpha} \to 0$ as $C$
grows, so $\rho_C \to 1$.
