...
\item
  ...
  converse force $\Omega(\sqrt N)$ query there? A negative answer would
  establish a general converse on the growing-horizon sources; a positive
  answer would exhibit a second escape beyond Ferragina--Venturini.
  Corollary 7.27e removes the false premise (``neural $\Rightarrow$ FV
  closes'') that previously over-stated this entry.
\end{itemize}
