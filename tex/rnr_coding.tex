...
\]
\emph{for structural constants $K_0(H) \geq 0$, $\alpha(H) \geq 0$.
...
\underbrace{\lceil \log_2(|\Sigma| + K_0(H) + \alpha(H) |\sigma|) \rceil}_{c(\sigma) \geq 1}
\]
...
($\alpha \geq 0$). Therefore the bit-cost-optimal cover
