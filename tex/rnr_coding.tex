...
Matching converses are given
for Type-I (Theorem 4.2) and Type-III-B (Theorem 6.3b, the byte
coder cannot beat the joint conditional entropy $H(H,L\mid C)$, so
the $I(H;L\mid C)$ advantage of Theorem 6.3 is exactly tight).
Complexity results include NP-hardness of the
