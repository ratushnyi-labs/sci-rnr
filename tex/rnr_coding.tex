...
subblock $i$. Suppose further that $H_v$ is a cryptographic hash
with negligible collision probability $\delta$ on the considered
set of candidate subblocks. Then the probability that an incorrect
$\hat{X}_i$ is used to update the predictor context for subblock
$i + 1$ is at most $\delta$.}
