...
$L_{\mathrm{synced}} \geq m \cdot H(D_K) = H(D_N) + (m-1) \cdot \delta_W$
\emph{for order-$W'$ Markov sources, matching the achievability
of (a) exactly. No scheme in the sub-block paradigm can do strictly
better.}
...
\Theta(W \log_2 \sigma)$ is engineering-determined per use case.
