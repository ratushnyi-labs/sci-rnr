...
\item
  ...
  Type-III-C) the GSGP/MSGP multi-string route is closed negatively
  and the predictor-absorption obstacle isolated, leaving only a
  PRG-conditional average-case decision-hardness escape that yields
  hardness of decision, not APX-hardness (§13.4.2, Theorem 13.4.2b).
