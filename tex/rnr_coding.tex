...
Remark 6.6b). Type-III-A has a matching \emph{relative} converse ---
the $2\varepsilon$ approximate-oracle gap is tight (Theorem 6.2) ---
but a standalone \emph{absolute-rate} converse for Type-III-A remains
open. Complexity results include
NP-hardness of the
