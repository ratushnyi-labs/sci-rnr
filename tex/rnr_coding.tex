...
\item
  ...
  coupling. Optimal fixed-size support selection for joint laws
  outside this class (where Remark 5.7's counterexample lives)
  remains open and is conjectured NP-hard via densest-$k$-subgraph.
\item
...
5.7's counterexample exhibits a concrete instance). The optimization problem
